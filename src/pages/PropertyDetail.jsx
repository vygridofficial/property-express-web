      ...
      <div className={`container ${styles.detailContainer}`}>
        ...
        <div className={styles.detailMain}>
          ...
          {(property.instagramLink || property.facebookLink || property.youtubeLink) && (
            <motion.div style={{ marginTop: '2rem', display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }} variants={revealVariants} initial="hidden" whileInView="visible" viewport={revealViewport}>
              {property.instagramLink && (
                <a href={property.instagramLink} target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'linear-gradient(135deg,#f09433,#dc2743,#bc1888)', color: 'white', border: 'none', padding: '0.7rem 1.25rem', borderRadius: '10px', fontWeight: 600, textDecoration: 'none', fontSize: '0.9rem' }}>
              ...
              {property.facebookLink && (
                <a href={property.facebookLink} target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#1877F2', color: 'white', border: 'none', padding: '0.7rem 1.25rem', borderRadius: '10px', fontWeight: 600, textDecoration: 'none', fontSize: '0.9rem' }}>
              ...
              {property.youtubeLink && (
                <a href={property.youtubeLink} target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#FF0000', color: 'white', border: 'none', padding: '0.7rem 1.25rem', borderRadius: '10px', fontWeight: 600, textDecoration: 'none', fontSize: '0.9rem' }}>
