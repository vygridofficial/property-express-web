      ...
      <div className={`container ${styles.detailContainer}`}>
        ...
        <div className={styles.detailMain}>
          <motion.div variants={revealVariants} initial="hidden" whileInView="visible" viewport={revealViewport}>
            {/* Status Badges */}
            <div className={styles.badgeGroup} style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem' }}>
              <span
            ...
            {(property.instagramLink || property.facebookLink || property.youtubeLink) && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', flexWrap: 'wrap', marginBottom: '0.75rem' }}>
                <span style={{ fontSize: '0.72rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: 'var(--color-text-light)', marginRight: '2px' }}>
                  Property Videos:
                </span>
                {property.instagramLink && (
                  <a href={property.instagramLink} target="_blank" rel="noopener noreferrer"
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: 'linear-gradient(135deg,#f09433,#dc2743,#bc1888)', color: 'white', padding: '0.28rem 0.7rem', borderRadius: 999, fontWeight: 600, textDecoration: 'none', fontSize: '0.72rem', lineHeight: 1 }}>
                ...
                {property.facebookLink && (
                  <a href={property.facebookLink} target="_blank" rel="noopener noreferrer"
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: '#1877F2', color: 'white', padding: '0.28rem 0.7rem', borderRadius: 999, fontWeight: 600, textDecoration: 'none', fontSize: '0.72rem', lineHeight: 1 }}>
                ...
                {property.youtubeLink && (
                  <a href={property.youtubeLink} target="_blank" rel="noopener noreferrer"
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: '#FF0000', color: 'white', padding: '0.28rem 0.7rem', borderRadius: 999, fontWeight: 600, textDecoration: 'none', fontSize: '0.72rem', lineHeight: 1 }}>
